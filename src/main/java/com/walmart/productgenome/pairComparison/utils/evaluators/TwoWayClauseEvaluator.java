...
public class TwoWayClauseEvaluator implements IAttributeMatchClauseEvaluator {
	...
	public boolean evaluate(final MatchEntity sourceItem, final MatchEntity targetItem, final AttributeMatchClause attributeMatchClause) {
		//return attributeMatchClause.evaluateClause(sourceItem, targetItem) && attributeMatchClause.evaluateClause(targetItem, sourceItem);
		return false;
	}
